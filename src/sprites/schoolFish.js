...
import SchoolFishPNG from '../spriteMaps/schoolFish.png';


class SchoolFish extends Sprite {
  constructor(context, posX, posY, speed) {
    const schoolFishSpriteSheet = new Image();
    const frameWidth = 100;
    const frameHeight = 100;
    const frames = 3;
    schoolFishSpriteSheet.src = SchoolFishPNG;
    
    super(context, posX, posY, schoolFishSpriteSheet, frameWidth, frameHeight, speed, frames);
    this.direction = -1;
    this.tween;
